...
function App() {
  ...
  return (
    <Router>
      ...
      <NavbarBrand className="nav-brand" href="/" id="navbar-brand" onMouseEnter={toggleTooltip} onMouseLeave={toggleTooltip}>
          Sakila Cinemas
        </NavbarBrand>
        <Tooltip placement="right" id="navbar-tooltip" isOpen={tooltipOpen} target="navbar-brand" toggle={toggleTooltip}>
          Return to Home Page
        </Tooltip>
        ...
        <Routes>
            ...
            element={
              <>
                ...
                <Carousel interval={3000}>
                  <Carousel.Item>
                    <img className="d-block w-100" src={cinemaImage} alt="First slide" />
                    <Carousel.Caption>
                      <h3>Feel free to peruse our selection!</h3>
                      <p>
                        <Link to="/films" className="carousel-link">Go to Films</Link>
                      </p>
                    </Carousel.Caption>
                  </Carousel.Item>

                  <Carousel.Item>
                    <img className="d-block w-100" src={actorImage} alt="Second slide" />
                    <Carousel.Caption>
                      <h3>Got a favorite celebrity?</h3>
                      <p>
                        <Link to="/actors" className="carousel-link">Go to Actors</Link>
                      </p>
                    </Carousel.Caption>
                  </Carousel.Item>

                  <Carousel.Item>
                    <img className="d-block w-100" src={customerImage} alt="Third slide" />
                    <Carousel.Caption>
                      <h3>See who else likes us!</h3>
                      <p>
                        <Link to="/customers" className="carousel-link">Go to Customers</Link>
                      </p>
                    </Carousel.Caption>
                  </Carousel.Item>
                </Carousel>
          ...
          <Route path="/actors"  element={<GetActor paginationModel={paginationModel} setPaginationModel={setPaginationModel} />} />

          <Route path="/customers" element={<> <GetCustomers /> </>} 
          />
        </Routes>
